...
enum NRF52_BLUETOOTH_COMMAND_CONSTANTS
{
    ...
    BLUETOOTH_UPDATE_GAP_PARAMS_COMMAND = 0X02,
    BLUETOOTH_INIT_GATT_COMMAND = 0X03,
    BLUETOOTH_INIT_SERVICES_COMMAND = 0X04,
    BLUETOOTH_INIT_CONN_PARAMS_COMMAND = 0X05,
    BLUETOOTH_INIT_BLE_STACK_COMMAND = 0X06,
    BLUETOOTH_INIT_PEER_MANAGER_COMMAND = 0X07,
    BLUETOOTH_INIT_ADVERTISING_COMMAND = 0X08,
    BLUETOOTH_TRANSMIT_RECORDING_SESSION_COMMAND = 0X09,
};
