...
enum NRF52_BLUETOOTH_COMMAND_CONSTANTS
{
    ...
    BLUETOOTH_ENABLE_ADVERTISING_AFTER_DISCONNECTION_COMMAND = 0X18,
};

enum NRF52_BLUETOOTH_TRANSMITTING_POWER_CONSTANTS
{
    BLUETOOTH_ADVERTISING_POWER_NEG_40_DB = 0X00,
    BLUETOOTH_ADVERTISING_POWER_NEG_20_DB = 0X01,
    BLUETOOTH_ADVERTISING_POWER_NEG_16_DB = 0X02,
    BLUETOOTH_ADVERTISING_POWER_NEG_12_DB = 0X03,
    BLUETOOTH_ADVERTISING_POWER_NEG_8_DB = 0X04,
    BLUETOOTH_ADVERTISING_POWER_NEG_4_DB = 0X05,
    BLUETOOTH_ADVERTISING_POWER_0_DB = 0X06,
    BLUETOOTH_ADVERTISING_POWER_3_DB = 0X07,
    BLUETOOTH_ADVERTISING_POWER_4_DB = 0X08,
};
...
enum NRF52_POWER_COMMAND_CONSTANTS
{
    ...
    NRF52_POWER_SOFT_DEVICE_SYSTEM_ON = 0X03,
    NRF52_POWER_SOFT_DEVICE_SYSTEM_OFF = 0X04,
