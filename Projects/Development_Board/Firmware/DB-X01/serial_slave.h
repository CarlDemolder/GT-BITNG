...
enum NRF52_BLUETOOTH_COMMAND_CONSTANTS
{
    ...
    BLUETOOTH_OVERRIDE_REQUEST_RECEIVED_COMMAND = 0X15,
};
...
enum FDC1004_COMMANDS_CONSTANTS
{
    ...
    FDC1004_TRIGGER_SINGLE_MEASUREMENT_COMMAND = 0X0A,
    FDC1004_GET_MEASUREMENT_COMMAND = 0X0B,
    FDC1004_UNINIT_COMMAND = 0X0C,
    FDC1004_ENABLE_CHANNEL_COMMAND = 0X0D,
    FDC1004_DISABLE_CHANNEL_COMMAND = 0X0E,
};
#endif
