...
void fdc1004_init(void)
{
    ...
    control.interrupt = 1;    // Initializing the interrupt to 0 to start out
...
void fdc1004_interrupt_handler(void)
{
    ...
    if(control.interrupt == 1)
    {
        ...
        for(uint8_t i = 0; i < ARRAY_LENGTH(control.cin_status); i++)
        {
            ...
            {
                fdc1004_trigger_single_measurement(i+1);  // Trigger channel measurement
                nrf_delay_us(2500);
        ...
        uint8_t ble_fdc1004_array_data[11] = {0x00, BLUETOOTH_MODULE, BLUETOOTH_WRITE_INSTANT_PRESSURE_CHAR_COMMAND, control.cin_data[0][0],
        control.cin_data[0][1], control.cin_data[1][0], control.cin_data[1][1], control.cin_data[2][0], control.cin_data[2][1],
        control.cin_data[3][0], control.cin_data[3][1]};  
...
static void _fdc1004_read_msb_measurement_register(uint8_t channel)
{
    ...
    i2c_read_single_register(control.slave_address, msb_measurement_register.register_pointer[channel-1], control.i2c_data, control.register_byte_count);
...
static void _fdc1004_read_lsb_measurement_register(uint8_t channel)
{
    ...
    i2c_read_single_register(control.slave_address, lsb_measurement_register.register_pointer[channel-1], control.i2c_data, control.register_byte_count);
    lsb_measurement_register.lsb_measurement[channel-1][0] = control.i2c_data[0];
}
...
static void _fdc1004_read_measurement_configuration_register(void)
{
    ...
    {
        i2c_read_single_register(control.slave_address, measurement_configuration_register.register_pointer[i], control.i2c_data, control.register_byte_count);
...
static void _fdc1004_write_measurement_configuration_register(void)
{
    ...
    for(uint8_t i = 0; i < ARRAY_LENGTH(measurement_configuration_register.register_pointer); i++)
    {
        ...
        i2c_write_single_register(control.slave_address, measurement_configuration_register.register_pointer[i], control.i2c_data, control.register_byte_count);
    }
}
...
static void _fdc1004_read_fdc_configuration_register(void)
{
    ...
    i2c_read_single_register(control.slave_address, fdc_configuration_register.register_pointer, control.i2c_data, control.register_byte_count);
...
static void _fdc1004_write_fdc_configuration_register(void)
{
    ...
    i2c_write_single_register(control.slave_address, fdc_configuration_register.register_pointer, control.i2c_data, control.register_byte_count);
}
...
static void _fdc1004_read_offset_calibration_register(void)
{
    ...
    {
        i2c_read_single_register(control.slave_address, offset_calibration_register.register_pointer[i], control.i2c_data, control.register_byte_count);
        offset_calibration_register.integer[i][0] = 0;
        offset_calibration_register.integer[i][1] = (control.i2c_data[0] & 0b11111000) >> 3;
...
static void _fdc1004_write_offset_calibration_register(void)
{
    ...
    for(uint8_t i = 0; i < ARRAY_LENGTH(offset_calibration_register.register_pointer); i++)
    {
        control.i2c_data[0] = (offset_calibration_register.integer[i][1] << 3) | offset_calibration_register.decimal[i][0];
        control.i2c_data[1] = offset_calibration_register.decimal[i][1];

        i2c_write_single_register(control.slave_address, offset_calibration_register.register_pointer[i], control.i2c_data, control.register_byte_count);
    }
}
...
static void _fdc1004_read_gain_calibration_register(void)
{
    ...
    {
        i2c_read_single_register(control.slave_address, gain_calibration_register.register_pointer[i], control.i2c_data, control.register_byte_count);
        gain_calibration_register.integer[i][0] = 0;
        gain_calibration_register.integer[i][1] = (control.i2c_data[0] & 0b11000000) >> 6;
...
static void _fdc1004_write_gain_calibration_register(void)
{
    ...
    for(uint8_t i = 0; i < ARRAY_LENGTH(gain_calibration_register.register_pointer); i++)
    {
        control.i2c_data[0] = (gain_calibration_register.integer[i][1] << 6) | gain_calibration_register.decimal[i][0];
        control.i2c_data[1] = gain_calibration_register.decimal[i][1];

        i2c_write_single_register(control.slave_address, gain_calibration_register.register_pointer[i], control.i2c_data, control.register_byte_count);
    }
}
...
static void _fdc1004_read_manufacturer_id_register(void)
{
    ...
    i2c_read_single_register(control.slave_address, control.manufacturer_id_register_pointer, control.i2c_data, control.register_byte_count);
...
static void _fdc1004_read_device_id_register(void)
{
    ...
    i2c_read_single_register(control.slave_address, control.device_id_register_pointer, control.i2c_data, control.register_byte_count);
...
static void _fdc1004_read_measurement(uint8_t channel)
{
    ...
    if(fdc_configuration_register.done[channel-1] == 1)
    {
        ...
        control.cin_data[channel-1][2] = lsb_measurement_register.lsb_measurement[channel-1][0];
